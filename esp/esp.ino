      ...
      prt+="                                              <body>";
                        prt+="                                <div class=data_now>";
                                     prt+="                       <div class=header_data_now>  ";
                                                    prt+="        <h1>Indicators of the sensors at the moment:</h1>";
              prt+="                                              </div>";
          ...
          prt+="                                              </div>";
                         ...
                         prt+="                               <div class=good_data>";
                                      prt+="                      <div class=header_good_data>  ";
                                                  prt+="              <h1>Good indicators for the plant:</h1>";
              prt+="                                              </div>";
                            prt+="                                <div class=humidity>";
                                                   prt+="             <p>Soil moisture: from 60% to 70%</p>";
              prt+="                                              </div>";
                                prt+="                            <div class=air_humidity>";
                                                    prt+="            <p>Air humidity: from 55% to 65%</p>";
              prt+="                                              </div>";
                                   prt+="                         <div class=air_temperature>";
                                                      prt+="          <p>Air temperature: from 19* to 22*</p>";
              prt+="                                              </div>";
          prt+="                                            </div>";

                           prt+="                             <div class=normal_data>";
                                          prt+="                  <div class=header_normal_data>  ";
                                                     prt+="           <h1>Normal indicators for a plant:</h1>";
              prt+="                                              </div>";
                            prt+="                                <div class=humidity>";
                                                   prt+="             <p>Soil moisture: from 50% to 80%</p>";
              prt+="                                              </div>";
                                prt+="                            <div class=air_humidity>";
                                                    prt+="            <p>Air humidity: from 45% to 70%</p>";
              prt+="                                              </div>";
                                   prt+="                         <div class=air_temperature>";
                                                        prt+="        <p>Air temperature: from 17.5* to 25*</p>";
              prt+="                                              </div>";
          prt+="                                              </div>";
prt+="                                                    ";
                        prt+="                                <div class=bad_data>";
                                     prt+="                       <div class=header_bad_data>  ";
                                prt+="          <h1> useful indicators for the plant:</h1>";
              prt+="                                              </div>";
                            prt+="                                <div class=humidity>";
                                       prt+="   <p>Soil moisture: less than 60% or more than 70%</p>";
              prt+="                                              </div>";
                                prt+="                            <div class=air_humidity>";                                      
                                prt+="  <p>Humidity: less than 55% or more than 65%</p>";
              prt+="                                              </div>";
                                   prt+="                         <div class=air_temperature>";
                                             prt+="<p>Air temperature: less than 19* or more than 22*</p>";
              prt+="                                              </div>";
          prt+="                                              </div>";
           prt+="                                             <style>";
         prt+="                                               html{";
